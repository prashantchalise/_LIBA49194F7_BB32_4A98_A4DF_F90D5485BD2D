...
; (function () {
    'use strict';
    rolpo_app.factory('wordsearchPrintService', ['$http', 'ngAuthSettings', function ($http, ngAuthSettings) {

        var serviceBase = ngAuthSettings.apiServiceBaseUri;
        var wordsearchPrintServiceFactory = {};
        ...
        wordsearchPrintServiceFactory.DDLDefaultFilter = _defaultDDLFilter;
        wordsearchPrintServiceFactory.GetDDLByFilter = _getDDLList;

        return wordsearchPrintServiceFactory;
    }]);
}());
...
; (function () {
    'use strict';
    rolpo_app.controller('WSPrintController', ['$scope', 'localService', 'wordsearchPrintService', 'modalService', '$uibModal', '$uibModalStack', '$filter', '$localStorage', function ($scope, localService, wordsearchPrintService, modalService, $uibModal, $uibModalStack, $filter, $localStorage) {

        // Variables and declarations  
        $scope.loading = false;
        $scope.wordsearch = wsjson;
        ...
        //Generate WordSearch 
        $scope.GenerateWordSearch = function () {
            MSG({});
            $scope.wordsearch.WORDS = [];
            var title = $('#WordSearchTitle').val();
            if (title == "" && !isFirstLoad) {
            ...
            const grid = { puzzle: $scope.puzzle, Title: title, Desc: "", width: canvasWidth, pad: 10, fontName: "Lucida Console", fontWeight: "bold", drawSolution: false };
